...
const firebaseConfig = {
  apiKey: process.env.REACT_APP_FIREBASE_API_KEY || "AIzaSyDevelopmentKeyForTesting123456789",
  authDomain: process.env.REACT_APP_FIREBASE_AUTH_DOMAIN || "smart-attendance-dev.firebaseapp.com",
  projectId: process.env.REACT_APP_FIREBASE_PROJECT_ID || "smart-attendance-dev",
  storageBucket: process.env.REACT_APP_FIREBASE_STORAGE_BUCKET || "smart-attendance-dev.appspot.com",
