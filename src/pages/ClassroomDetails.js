...
const ClassroomDetails = () => {
  ...
  const { showSuccess, showError, confirmDelete, showLoading, hideLoading } =
    useNotifications();
  ...
  const handleDeleteSubject = async (subject) => {
    const confirmed = await confirmDelete(subject.name, async () => {
      try {
                  ...
                  {classroom.subjects && classroom.subjects.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400">
                        Add subjects to organize your classroom content
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-xl">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm text-gray-600">
                ...
                {(classroom.students?.length || 0) !== 1 ? "s" : ""}
              </div>
            </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full flex items-center justify-center">
                        <span className="font-medium text-blue-700">
                          {(student.name || student.firstName || "S")
                            .charAt(0)
                            .toUpperCase()}
                        </span>
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">
                          ID: {student.studentId || student.id || "N/A"}
                        </p>
                        {student.email && (
                          <p className="text-sm text-gray-600">
                            {student.email}
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {student.joinedAt && (
                        <p className="text-xs text-gray-500">
                          Joined:{" "}
                          {student.joinedAt.toDate
                            ? student.joinedAt.toDate().toLocaleDateString()
                            : new Date(student.joinedAt).toLocaleDateString()}
                        </p>
                      )}
                    </div>
