    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Parent Registration Request</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <span>Child: {request.childName}</span>
        </div>
        <div className="flex items-center space-x-2 text-sm text-gray-600">
      ...
      <div className="bg-gray-50 rounded-xl p-4 mb-4">
        <h4 className="text-sm font-medium text-gray-900 mb-2">Child Information</h4>
      ...
      {request.status === 'pending' && (
        <div className="flex space-x-3">
          <button
            ...
            disabled={loading}
            className="flex-1 bg-red-500 text-white py-2 px-4 rounded-xl font-medium hover:bg-red-600 transition-all duration-200 disabled:opacity-50"
          >
            Reject
          </button>
          <button
            ...
            disabled={loading}
            className="flex-1 bg-green-500 text-white py-2 px-4 rounded-xl font-medium hover:bg-green-600 transition-all duration-200 disabled:opacity-50"
          >
            Approve
          </button>
        </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Child Registration Requests</h2>
        ...
        <div className="p-6">
          {requests.length === 0 ? (
            <div className="text-center py-12 text-gray-500">
              ...
              <p>There are no child registration requests at the moment.</p>
            </div>
          ) : (
