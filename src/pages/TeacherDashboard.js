...
const TeacherDashboard = () => {
  ...
  // Teacher and class info (in a real app, this would come from authentication)
  const teacherId = 'teacher_001';
  const classId = 'CS-301';
  const subject = 'Computer Science';

  // Load students and check for active session on component mount
  useEffect(() => {
    loadStudents();
    checkActiveSession();
    detectLocation();
